...
updater.addon = "assetify_updater"
...
def register(bl_info):
    ...
    updater.repo = "Assetify"

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/defoqofficial/Assetify"
    ...
    updater.include_branch_list = ["master", "debug"]  # None is the equivalent = ['master']
